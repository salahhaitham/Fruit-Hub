...
import 'package:ecommerce_app/Features/checkout/data/models/OrderEntityModel.dart';
...
class OrdersRepoImpl extends OrdersRepo{
  ...
  Future<Either<Failure, void>> addOrder(OrderEntity order) async{
    try {
    await  databaseServices.adddata(collection: Backend_EndPoints.Koreders, data: OrderEntityModel.fromOrderEntity(order).toJson());
      return right(null);
